...
```
kubectl apply -f https://raw.githubusercontent.com/tektoncd/catalog/main/task/github-add-labels/0.2/github-add-labels.yaml
```
...
[This](../0.2/samples/run.yaml) can be referred to create a Taskrun.
