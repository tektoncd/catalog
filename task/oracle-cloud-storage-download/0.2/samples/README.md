...
1. **Important**: Edit the secret template with your actual OCI credentials first!
   
2. Create the OCI credentials secret:
   ```bash
   kubectl apply -f https://github.com/tektoncd/catalog/raw/main/task/oracle-cloud-storage-download/0.2/samples/secret-template.yaml
   ```

3. Apply the task definition:
   ```bash
...
4. Run one of the examples:
   ```bash
   # Directory download
   kubectl create -f https://github.com/tektoncd/catalog/raw/main/task/oracle-cloud-storage-download/0.2/samples/taskrun-example.yaml
   
   # Single file download
   kubectl create -f https://github.com/tektoncd/catalog/raw/main/task/oracle-cloud-storage-download/0.2/samples/taskrun-single-file.yaml
   
   # Complete pipeline
   kubectl create -f https://github.com/tektoncd/catalog/raw/main/task/oracle-cloud-storage-download/0.2/samples/pipeline-download-directory.yaml
   ```
