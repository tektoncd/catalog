...
[This task](../../gitlab-add-label/0.2/gitlab-add-label.yaml) can be used to add labels to the gitlab `issue` or `merge request` (pull request).


### Install the Task

```
kubectl apply -f https://raw.githubusercontent.com/tektoncd/catalog/main/task/gitlab-add-label/0.2/gitlab-add-label.yaml
```
