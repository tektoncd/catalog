...
This Task runs [Apache Camel](https://camel.apache.org/) integrations using `camel` CLI command provided in the base image.

[Camel JBang](https://camel.apache.org/manual/camel-jbang.html) is a lightweight tool for running Camel routes without requiring complex setup or operators. It supports multiple runtimes (Camel Main, Spring Boot, Quarkus) and provides features like live reload, developer console, and observability.
